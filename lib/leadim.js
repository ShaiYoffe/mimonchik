...
export async function fireRouteAdv(leadId, sourceDomain) {
  ...
  // fld_179827 — source domain (added 2026-05-28). When this routes a lead
  // from the RouteGuard cron, this stamps the lead with the originating site.
  if (sourceDomain) body.append('fld_179827', sourceDomain);
